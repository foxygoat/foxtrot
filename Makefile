...
jcdc-deploy-%:
	curl --data '$(JCDC_DEPLOY_PAYLOAD)' --silent --show-error --retry 3 --dump-header - '$(JCDC_URL)'
...
jcdc-undeploy-%:
	curl --data '$(JCDC_UNDEPLOY_PAYLOAD)' --silent --show-error --retry 3 --dump-header - '$(JCDC_URL)'
